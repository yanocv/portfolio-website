      ...
      <div className="container">
        ...
        <div className="row">
          <div className="col-md-4 col-xs-6">
            <PortfolioItem
              imgSrc={`${basePath}/assets/img/portfolio1.png`}
          ...
          <div className="col-md-4 col-xs-6">
            <PortfolioItem
              imgSrc={`${basePath}/assets/img/portfolio2.png`}
              title="Cross-cat"
          ...
          <div className="col-md-4 col-xs-6">
            <PortfolioItem
              imgSrc={`${basePath}/assets/img/portfolio3.png`}
              title="Cross-echo"
          ...
          <div className="col-md-4 col-xs-6">
            <PortfolioItem
              imgSrc={`${basePath}/assets/img/portfolio4.png`}
          ...
          <div className="col-md-4 col-xs-6">
            <PortfolioItem
              imgSrc={`${basePath}/assets/img/portfolio5.png`}
          ...
          <div className="col-md-4 col-xs-6">
            <PortfolioItem
              imgSrc={`${basePath}/assets/img/portfolio6.png`}
              title="Coming Soon"
